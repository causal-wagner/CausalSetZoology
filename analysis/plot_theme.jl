...
"""
    Makie.get_minor_tickvalues(::typeof(logminorticks), ::Union{typeof(log), typeof(log10), typeof(log2)}, ::Any, lo::Real, hi::Real)
...
# Returns
- `figsize::Tuple{Real,Real}` suitable for `Figure(size = figsize)`.

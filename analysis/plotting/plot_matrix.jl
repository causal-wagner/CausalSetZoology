...
function observable_distinguishability_symbol_labels()
    return (
        ...
        height_distribution = LaTeXStrings.L"\mathcal{H}_j",
    )
end
...
function graph_observable_field_spec(observable::Symbol)
    ...
    elseif observable == :height_distribution
        return (field = :height_distribution_hist, hist = true, normalization = :probability)

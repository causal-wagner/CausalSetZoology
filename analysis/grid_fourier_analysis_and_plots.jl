...
# Returns
- `(fig, ax)`: The created Makie `Figure` and its `Axis`.
...
`fft(grid_abundance ./ comp_hist .- 1)` over positive frequencies above
`1 / P_max`.
...
# Returns
- `Figure`: The generated Fourier spectrum figure.
